...
import { Container, Typography, Paper, Button, Grid, Theme } from '@material-ui/core'
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Typography variant="body1" className={classes.content}>
              Today I bought a raincoat and wore it on a sunny day. He had decided to
              accept his fate of accepting his fate. I caught my squirrel rustling through
              my gym bag.
            </Typography>
          </Grid>
